...
```{r To finalise the corpus version 4 including tv shows}
climate_corpus_v4 <- read_delim("2.data_transformations/data/climate_sub_corpus/climate_corpus_v4.csv", 
    delim = ";", escape_double = FALSE, trim_ws = TRUE)
climate_corpus_v4 <- climate_corpus_v4 %>% left_join(Tvshows, by = c("doc_id" = "code"))
write_csv2(climate_corpus_v4, file = "climate_corpus_v4.csv", quote = "none")
```
